...
<span style="color:#0033cc; font-weight:bold; line-height:30px">Workflows for sample handling and analytical methods:</span><br/>
...
$query = mysql_query("select * FROM documents WHERE code LIKE'%WF%'");
