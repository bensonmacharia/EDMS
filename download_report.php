...
<td>
<center>
<h2 style="font-family:Verdana, Arial, Helvetica, sans-serif"><b style="color:#0c6500">Downloads Report</b></h2><br/>
</center>
<style>
table {
...
$result = mysqli_query($connection,"select * FROM documents ORDER BY record");
echo "<table class='bordered'>"; // start a table tag in the HTML
echo "<tr>"; echo "<th>Code </th>";echo "<th>Title </th>";echo "<th>Authors</th>";echo "<th>Category</th>"; echo "<th>Downloads</th>"; echo "</tr>";
while($row = mysqli_fetch_array($result))
{
$code=$row['code'];
echo "<tr><td><a href='document_details.php?code=$code'>" . $row['code'] . "</a></td><td>" .$row['title'] . "</td><td>" . $row['authors'] ."</td><td>" . $row['record']."</td><td>" . $row['downloads']."</td></tr>";
}
