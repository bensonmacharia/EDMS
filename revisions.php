...
<td>
<center>
<h2 style="font-family:Verdana, Arial, Helvetica, sans-serif"><b style="color:#0c6500">My Revisions</b></h2><br/>
</center>
<style>
table {
...
$data = mysqli_query($connection,"select * FROM documents WHERE review = 1 and authors LIKE'%$user_name%'"); 
echo "<table class='bordered'>"; // start a table tag in the HTML

echo "<tr>"; echo "<th>Code </th>";echo "<th>Title </th>";echo "<th>Size </th>";echo "<th>Authors </th>"; echo "<th>Date/Time Upload</th>"; echo "<th>Evaluate Before </th>"; echo "</tr>";
 while($row = mysqli_fetch_array($data))
 { 
 $code=$row['code'];
 echo "<tr><td>"."<a href='edms_revisionoptions.php?code=$code'>" . $row['code'] . "</a></td><td>" .$row['title'] . "</td><td>" . $row['size'] ."Kbs"."</td><td>" . $row['authors']. "</td><td>". $row['date_upload'] . "</td><td>" . $row['evaluate_before'] ."</td></tr>";
