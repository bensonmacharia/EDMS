...
<td>
<center>
<h2 style="font-family:Verdana, Arial, Helvetica, sans-serif"><b style="color:#0c6500">Documents expiry Report</b></h2><br/>
</center>
<style>
table {
...
$result = mysqli_query($connection,"select * FROM documents WHERE evaluate_before >= DATE(now())");
echo "<table class='bordered'>"; // start a table tag in the HTML
echo "<tr>"; echo "<th>Code </th>";echo "<th>Title </th>";echo "<th>Authors</th>";echo "<th>Evaluate Before</th>"; echo "<th>Days to Expire</th>"; echo "</tr>";
...
$code=$row['code'];
echo "<tr><td><a href='document_details.php?code=$code'>" . $row['code'] . "</a></td><td>" .$row['title'] . "</td><td>" . $row['authors'] ."</td><td>" . $row['evaluate_before']."</td><td>" . $days_to_expire."</td></tr>";
}
