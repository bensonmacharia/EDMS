  ...
  <div id="main1">
    <center>
      <table>
        <tr>
          <td><center>
              <h2 style="font-family:Verdana, Arial, Helvetica, sans-serif"><b style="color:#0c6500">Users to be Approved</b></h2>
              <br/>
            </center>
            <style>
table {
...
echo "<tr>"; echo "<th>First Name </th>"; echo "<th>Second Name  </th>";  echo "<th>Email </th>"; echo "<th>Class </th>"; echo "<th>Position</th>";echo "<th>Approve</th>"; echo "</tr>";
while($row = mysqli_fetch_array($result)){   //Creates a loop to loop through results
$email=$row['email'];
echo "<tr><td>" . $row['fname'] . "</td><td>" . $row['sname'] ."</td><td>" . $email."</td><td>". $row['class'] ."</td><td>".$row['position'] . "</td><td><a href='approve_users.php?email=$email'><img src='images/continue.png'></a></td></tr>"; 
}
