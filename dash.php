  ...
  <div id="main">
    <center>
      <table>
        <tr>
          <td><center>
              <h2 style="font-family:Verdana, Arial, Helvetica, sans-serif"><b style="color:#0c6500"><?php echo $type."&nbsp;Dashboard"?></b></h2>
              <br/>
            </center>
			...
			echo"<a href='new-users.php'>New Users Guide</a>";
			
			echo"<img src='images/flowchart.png'>";
            ?>
          </td>
        </tr>
      </table>
