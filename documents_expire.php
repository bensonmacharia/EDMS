...
$result = mysqli_query($connection,"select * FROM documents WHERE evaluate_before >= DATE(now()) AND evaluate_before <= DATE_ADD(DATE(now()), INTERVAL 1 MONTH)");
echo "<table class='bordered'>"; // start a table tag in the HTML
echo "<tr>"; echo "<th>Code </th>";echo "<th>Title </th>";echo "<th>Authors</th>";echo "<th>Date Expire</th>"; echo "<th>Days to Expire</th>"; echo "</tr>";
