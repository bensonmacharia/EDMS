...
<td>
<center>
<h2 style="font-family:Verdana, Arial, Helvetica, sans-serif"><b style="color:#0c6500">Documents to be Approved</b></h2><br/>
</center>
<style>
table {
...
$query = "SELECT * FROM documents WHERE approved = '0'"; //You don't need a ; like you do in SQL
$result = mysqli_query($connection,$query);
echo "<table class='bordered'>"; // start a table tag in the HTML

echo "<tr>"; echo "<th>Code </th>";echo "<th>Title </th>";echo "<th>Authors </th>";echo "<th>Size </th>"; echo "<th>Date/Time upload </th>"; echo "</tr>";
while($row = mysqli_fetch_array($result))
{   //Creates a loop to loop through results
$code=$row['code'];
echo "<tr><td><a href='approve.php?code=$code'>" . $row['code'] . "</a></td><td>" .$row['title'] . "</td><td>" . $row['authors'] ."</td><td>" . $row['size'] ."</td><td>" . $row['date_upload']."</td></tr>";
}
