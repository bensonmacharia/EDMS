...
<span style="color:#0033cc; font-weight:bold; line-height:30px">SOPs for operating instruments, apparatus and other equipment:</span><br/>
<span>There are a total of 23 SOPS in this category and include:</span></br></br>
<style>
table {
...
$query = mysqli_query($connection,"select * FROM documents WHERE code LIKE'%EQUP%'");
