...
<td>
<center>
<h2 style="font-family:Verdana, Arial, Helvetica, sans-serif"><b style="color:#0c6500">Restore/Delete Permanently</b></h2><br/>
<style>
table {
...
$query = "SELECT * FROM edms_delete"; //You don't need a ; like you do in SQL
$result = mysqli_query($connection,$query);
echo "<table class='bordered'>"; // start a table tag in the HTML
//echo "Docuemnts sorted by:" ."&nbsp;&nbsp;".$sort;
echo "<tr>"; echo "<th>Index </th>";echo "<th>Name </th>";echo "<th>Category </th>";echo "<th>Author </th>"; echo "<th>Size(KB) </th>"; echo "<th>Date/Time Deleted </th>"; echo "</tr>";
while($row = mysqli_fetch_array($result)){   //Creates a loop to loop through results
$id=$row['del_id'];
echo "<tr><td>" . $row['del_id'] . "</td><td>"."<a href='edms_restoredeletespecific.php?id=$id'>" .$row['filename'] . "</a>"."</td><td>" . $row['category'] ."</td><td>" . $row['auth_name'] ."</td><td>". $row['size'] ."Kbs". "</td><td>" . $row['del_date'] ."</td></tr>";
}
echo "</table>"; //Close the table in HTML
if (isset($_POST['restore'])) {
$data = mysqli_query($connection,"select * FROM edms_delete"); 
}
