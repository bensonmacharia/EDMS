  ...
  <div id="main1">
    <center>
      <table>
        <tr>
          <td><center>
              <h2 style="font-family:Verdana, Arial, Helvetica, sans-serif"><b style="color:#0c6500">Downloads Requests</b></h2>
              <br/>
            </center>
<style>
table {
...
$query = "SELECT * FROM downloads WHERE approved = '0'"; 

$result = mysqli_query($connection,$query);
echo "<table class='bordered'>"; // start a table tag in the HTML
//echo "Docuemnts sorted by:" ."&nbsp;&nbsp;".$sort;
       
echo "<tr>"; echo "<th>Document Code</th>"; echo "<th>Names </th>"; echo "<th>Position </th>"; echo "<th>Date-Time</th>"; echo "<th>Approve</th>";echo "</tr>";
while($row = mysqli_fetch_array($result)){   //Creates a loop to loop through results
$code=$row['code'];
echo "<tr><td><a href='document_details.php?code=$code'>" . $row['code'] . "</a></td><td>" . $row['fname'] ."&nbsp;" . $row['sname']. "</td><td>".$row['position'] ."</td><td>". $row['request_date']."</td><td><a href='approve_downloads.php?code=$code'><img src='images/approved.png'></a></td></tr>"; 
}
