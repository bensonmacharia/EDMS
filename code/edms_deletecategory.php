  ...
  <center>
    <table>
      <tr>
        <td>
        <center>
          <h2 style="font-family:Verdana, Arial, Helvetica, sans-serif"><b style="color:#0c6500">Delete Category</b></h2>
          <br/>
...
if (isset($_POST['delete'])) {
	         ...
	         echo "<script>if(r==true){location.href=\"confirm_delete_category.php?field=$field\";}else{location.href=\"edms_deletecategory.php\";}</script>";	
			 }   
 ?>
        </td>
      </tr>
