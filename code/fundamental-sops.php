...
<span style="color:#0033cc; font-weight:bold; line-height:30px">Fundamental SOPs:</span><br/>
<span>The are two fundamental SOPs that include:</span></br></br>
<style>
table {
...
$query = mysqli_query($connection,"select * FROM documents WHERE code LIKE'%F%'");
