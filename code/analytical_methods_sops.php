...
<span style="color:#0033cc; font-weight:bold; line-height:30px">SOPs for analytical methods:</span><br/>
...
<?php
$query = mysqli_query($connection,"select * FROM documents WHERE code LIKE'%METH%'");
