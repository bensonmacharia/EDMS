...
<span style="color:#0033cc; font-weight:bold; line-height:30px">SOPs for Quality assurance:</span><br/>
<span>These SOPs are 5 in total and include:</span></br></br>
<style>
table {
...
$query = mysqli_query($connection,"select * FROM documents WHERE code LIKE'%QC%'");
