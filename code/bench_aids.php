...
<span style="color:#0033cc; font-weight:bold; line-height:30px">Bench aids for equipment use, operations and maintenance:</span><br/>
<span>The documents in this category are:</span></br></br>
<style>
table {
...
<?php
$query = mysqli_query($connection,"select * FROM documents WHERE code LIKE'%BA%'");
