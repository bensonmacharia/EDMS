  ...
  <div id="main1">
    <center>
      <table>
        <tr>
          <td><center>
              <h2 style="font-family:Verdana, Arial, Helvetica, sans-serif"><b style="color:#0c6500">System Reports</b></h2>
              <br/>
            </center>
            <b style="color:#0033cc">Document Downloads</b><br/>
  <?php
	
?>

            
<b style='color:#0033cc'>Available users</b><br/>
