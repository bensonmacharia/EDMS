...
<span style="color:#0033cc; font-weight:bold; line-height:30px">SOPs for receiving, logging, processing, archiving and disposal of samples:</span><br/>
<span>There are 13 SOPS in this category and include:</span></br></br>
<style>
table {
...
$query = mysqli_query($connection,"select * FROM documents WHERE code LIKE'%PROT%'");
