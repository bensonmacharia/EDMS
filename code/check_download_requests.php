...
<td>
<center>
<h2 style="font-family:Verdana, Arial, Helvetica, sans-serif"><b style="color:#0c6500">Documents Requested</b></h2><br/>
</center>
<style>
table {
...
$query = "SELECT * FROM downloads WHERE email = '$user_check'"; 
$result = mysqli_query($connection,$query);
echo "<table class='bordered'>"; // start a table tag in the HTML

echo "<tr>"; echo "<th>Code </th>";echo "<th>Title </th>";echo "<th>Request Date </th>"; echo "<th>Status</th>"; echo "</tr>";
while($row = mysqli_fetch_array($result))
{   //Creates a loop to loop through results
$code=$row['code'];
$state=$row['approved'];
if($state = 1){$status = 'Approved';}else{$status = 'Pending Approval';}
echo "<tr><td><a href=''>" . $code. "</a></td><td>" .$row['title'] . "</td><td>" . $row['request_date'] ."</td><td>" . $status."</td></tr>";
}
