...
<td>
<center>
<h2 style="font-family:Verdana, Arial, Helvetica, sans-serif"><b style="color:#0c6500">Message(s) Sent</b></h2><br/>
</center>
<style>
table {
...
<?php
$query = "SELECT * FROM messages WHERE email = '$user_check'"; //You don't need a ; like you do in SQL
$result = mysqli_query($connection,$query);
echo "<table class='bordered'>"; // start a table tag in the HTML

echo "<tr>"; echo "<th>Date/time sent </th>";echo "<th>Message </th>";echo "<th>Email </th>";echo "<th>Status </th>"; echo "</tr>";
while($row = mysqli_fetch_array($result))
{   //Creates a loop to loop through results
$state=$row['isread'];
if($state = 1){$status = 'Read';}else{$status = 'Not Read';}
echo "<tr><td>" . $row['date_sent']. "</td><td>" .$row['message'] ."</td><td>" .$row['email'] ."</td><td>" . $status."</td></tr>";
}
